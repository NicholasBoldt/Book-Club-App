# Generated by Django 3.1.3 on 2021-01-29 21:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('disc_type', models.CharField(choices=[('comment', 'Comment'), ('quesiton', 'Discussion Quesion'), ('quote', 'Quote')], max_length=100)),
        ...
        migrations.AddField(
            model_name='book',
            name='meeting',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.meeting'),
        ),
    ]
